...
def main():
    ...
    input_file_path = 'Spark_WordCount_Session\AChristmasCarol_CharlesDickens_English.txt'
    output_file_path = 'Spark_WordCount_Session\output_spark.txt'
    
    # Read the text file into an RDD
    text_file = spark.sparkContext.textFile(input_file_path)
